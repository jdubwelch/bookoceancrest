...
class CalendarPresenterTest extends \PHPUnit_Framework_TestCase
{
    ...
    function it_makes_a_link_to_an_event_page()
    {
        ...
        $expected = '<a href="details.php?day=2/4/2016">4</a>';
    ...
    {
        $expected = '<a href="add_event.php?day=2/4/2016">4</a>';
    ...
    {
        $link = $this->presenter->link_to_event(4);
        $expected = '<td class="thursday welch_week reserved"><div class="day">'.$link.'</div><div class="event">Jason & Deena</div></td>';
    ...
    function it_creates_the_markup_for_a_cell_with_no_event()
    {
        ...
        $expected = '<td class="friday welch_week"><div class="day">'.$link.'</div><div class="event"></div></td>';
